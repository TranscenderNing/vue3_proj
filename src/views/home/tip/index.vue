<template>
    <div class="tip">
        ...
        <div class="notice">
            <div class="top">
                <div class="left">
                    <svg t="1695806809626" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="8680" width="16" height="16"><path d="M768.554667 824.490667v64H258.666667v-64h509.888zM906.666667 181.333333v533.333334h-789.333334v-533.333334h789.333334z m-64 64h-661.333334v405.333334h661.333334v-405.333334z m-115.712 237.824v64h-426.666667v-64h426.666667z m0-149.333333v64h-426.666667v-64h426.666667z" fill="#1677FF" p-id="8681"></path></svg>
                    <span>平台公告</span>
                </div>
                <div class="right">
                    <span>全部</span>
